...
struct cadastro{  //definição da estrutura
...
int main(void) {
  ...
  printf("Nome........: %s", pessoa.nome); QL;
  printf("Idade.......: %d", pessoa.idade);QL;
  printf("Endereço....: %s", pessoa.endereco);QL;
  printf("Número......: %d", pessoa.numero);QL;
  return 0;
}